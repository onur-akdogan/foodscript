                ...
                <table class="table datatable-responsive" id="example">
                    ...
                    @foreach ($fixedPage as $row )
                        <tr>
                            ...
                            <td>           
                                            <a href="{{route('fixedpage.editPage',$row->id)}}" class="dropdown-item"><i class="fa fa-cog fa-2x" style="color:green" aria-hidden="true"></i> </a>
                
                            </td>
<td>
    <a href="{{route('fixedpage.delete',$row->id)}}" onclick="return confirm('Silmek istediğinizden emin misiniz ?')"
        class="dropdown-item"><i class="fa fa-times fa-2x" style="color:red" aria-hidden="true"></i></a>
</td>
                        </tr>
                    @endforeach
